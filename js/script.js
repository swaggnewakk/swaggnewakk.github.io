$(document).ready(function(){
  ...
  var i = +($('.inforow').attr("id")) + 1;

  $("#addrow").click(function(){
    $(".table-append-item").append( $('<tr id="'+ i +'" class="inforow"><td><input name="Страница каталога '+ i +'" type="number"></td><td><input name="Код продукта '+ i +'" type="text"></td><td><input name="Кол-во '+ i +'" type="number"></td></tr>') );
    i++;
  });
  ...
  $(".checkbox-slide").on("click", function(){
    $(".form-add-custom").slideToggle("slow");
    if($(this).is(":checked")){
      $(".form-add-custom").find("input").prop('required', false);
    }
    else{
      $(".form-add-custom").find("input").prop('required', true);
    }
  });
